...
class PARALLEL_HILL_CLIMBER:
    ...
    def Print(self):
        allFitnessFile = open("finalProject/fitness/hexapod2Fitness" + str(self.iteration) + ".csv", "a")
        if (os.stat("finalProject/fitness/hexapod2Fitness" + str(self.iteration) + ".csv").st_size == 0):
    ...
    def Show_Best(self, num):
        ...
        os.system('mv brain' + str(bestSolution.myID) + '.nndf finalProject/brains/hexapod2/brain' + str(num) + '.nndf')
